              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    hintText:
                        'e.g. Kolkata → Darjeeling, Pacific Coast Highway, Leh Ladakh...',
                  ),
                ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  const Text(
                    'Generated Waypoints & Daily Stops:',
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                  ),
                  const SizedBox(height: 8),
                  ...draftTour.waypoints.map(
                    (wp) => Padding(
                  ...
                  Wrap(
                    spacing: 6,
                    runSpacing: 6,
                    children: draftTour.includedGear
                        .map(
                          (g) => Chip(
                            label: Text(
                              g,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        appState.setNavIndex(
                          11,
                        ); // Go to register tour screen with draft prefilled
                      },
                      icon: const Icon(Icons.publish_rounded),
                      label: const Text(
                        'Publish as Guided Group Tour',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                        ),
